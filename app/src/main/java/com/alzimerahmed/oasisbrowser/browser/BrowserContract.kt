...
interface BrowserContract {
    ...
    interface View {
         ...
         */
        fun renderTabs(tabs: List<TabListItem>)
        ...
        /**
         * Update the find-in-page match count badge.
         *
         * @param activeMatch The 1-based index of the currently highlighted match.
         * @param totalMatches The total number of matches on the page.
         */
        fun showFindResult(activeMatch: Int, totalMatches: Int)

        /** Read the current page text using the Android system Text to Speech service. */
        fun speakPageText(text: String)

        /**
         * Show a reader-mode overlay for the provided [title] and cleaned [html].
         */
        fun showReaderView(html: String, title: String)

        /**
         * Hide the reader-mode overlay and return to the normal tab view.
         */
        fun hideReaderView()

        /**
         * Show a snackbar allowing the user to undo a tab close.
         *
         * @param onUndo invoked when the user taps the undo action.
         */
        fun showUndoTabCloseSnackbar(onUndo: () -> Unit)
        ...
        /**
         * Show the tab group options dialog for the tab with the provided [id].
         *
         * @param tabId The tab to be grouped/ungrouped.
         * @param groups The current tab groups that the tab can be added to.
         */
        fun showTabGroupDialog(tabId: Int, groups: List<TabGroup>)
