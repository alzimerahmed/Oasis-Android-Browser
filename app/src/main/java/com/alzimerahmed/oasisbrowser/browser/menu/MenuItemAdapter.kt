package com.alzimerahmed.oasisbrowser.browser.menu
...
class MenuItemAdapter @Inject constructor() {
    ...
    fun adaptMenuItem(menuItem: MenuItem): MenuSelection? {
        return when (menuItem.itemId) {
            ...
            R.id.action_reading_list -> MenuSelection.READING_LIST
            R.id.action_add_bookmark -> MenuSelection.ADD_BOOKMARK
            R.id.action_reader_mode -> MenuSelection.READER_MODE
            R.id.action_add_to_collection -> MenuSelection.ADD_TO_COLLECTION
